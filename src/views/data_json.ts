export const data = [
	...
	{
		原始数据: '基于原生多模态大模型的医疗智能体服务矩阵——安诊儿2.0',
		对比数据: '基于智能诊疗系统的多模态医疗平台——安诊儿3.0'
	},
	{
		原始数据: '西湖大学建设工程三期',
		对比数据: '西湖大学校园建设四期工程'
	...
	{
		原始数据: '杭政储出【2023】39号地块住宅（设配套公建）项目',
		对比数据: '杭政储出【2023】42号地块住宅（含公共配套设施）项目'
	},
	{
		原始数据: '杭政储出【2021】12号地块住宅（设配套公建）',
		对比数据: '杭政储出【2021】14号地块住宅项目（含社区配套设施）'
	},
	{
