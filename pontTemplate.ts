...
export default class MyGenerator extends CodeGenerator {
	...
	getInterfaceContent(inter: Interface) {
		...
		paramsCode = paramsCode.replace(':', '!:')
		const initialValue = inter.response.getInitialValue()
		const typeFlag = initialValue.includes('new defs.') ? '' : 'type'
    ...
    import ${typeFlag} * as defs from '../../baseClass';
